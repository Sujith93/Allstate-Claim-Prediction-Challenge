...
# encoding_data<-Data_encoding(sampledata_df<-"E:\\Chandu/From/BizDynamics/Demo/BD/Association/AssociaotionRules/inputdata/rem_misng_data.csv")
# 
# write.csv(encoding_data,"E:\\Chandu/From/BizDynamics/Demo/BD/Association/AssociaotionRules/inputdata/RSA_dummies_creation_data.csv")
